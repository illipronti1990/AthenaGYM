# ATHENAS GYM ERP — Documento Técnico de Arquitetura

**Versão:** 3.0 (Fase 3 — Login Real)  
**Produto:** `ATHENAS_GYM_ERP_COMERCIAL.xlsm`  
**Objetivo:** padrões para manutenção, evolução e controle de acesso.
...
| `ModuloAthenas` monolítico | `modLogin`, `modAluno`, … | Parcial (auth extraído) |
