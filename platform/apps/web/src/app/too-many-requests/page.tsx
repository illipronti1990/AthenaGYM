...
export default function TooManyRequestsPage() {
  return (
    <main
      ...
      data-testid="error-page-429"
    >
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src={MOVVO_PRODUCT.assets.logo} alt="Movvo ERP" width={160} height={40} />
      <p className="text-sm uppercase tracking-[0.2em] text-[var(--warning)]">429</p>
      <h1 className="font-[family-name:var(--font-display)] text-3xl font-bold">
        Muitas requisições
      </h1>
      <p className="max-w-md text-[var(--muted)]">
        Aguarde um momento e tente novamente. {MOVVO_PRODUCT.slogan}
      </p>
      <Link
        href="/app"
