...
export function MovvoDataGrid<T>({
  tableId,
  columns,
  rows,
  total,
  ...
  return (
    <div className="movvo-dg" data-testid={`datagrid-${tableId}`}>
      <WorkPanels
        panels={workPanels}
          ...
          <table className="movvo-dg-table">
            <thead>
              <tr>
                ...
                {rowActions.length ? <th className="movvo-dg-actions-col">Ações</th> : null}
              </tr>
            </thead>
            <tbody>
              {padTop > 0 ? (
              ...
              {slice.map((row) => {
                ...
                return (
                  ...
                  >
                    ...
                    {rowActions.length ? (
                      <td className="movvo-dg-actions-col">
